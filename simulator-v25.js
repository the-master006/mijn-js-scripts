...
(function() {
    ...
    function generateReport() {
        ...
        // Bepaal aanbevolen pakket: hoogste lifetimeSavings met ROI <= 10 jaar
        var recommendedPakket = null;
        var recommendedResult = null;
        var bestLifetimeSavings = -Infinity;
        
        // Loop door alle pakketten (skip 0 = geen batterij)
        for (var i = 1; i < PAKKETTEN.length; i++) {
            var result = simulationResults.scenarios[i] || simulateScenario(i);
            
            // Check of ROI binnen 10 jaar is
            if (result.roiYears && result.roiYears <= 10) {
        ...
        if (recommendedPakket) {
            ...
            recommendation = 'Op basis van uw huidige configuratie is er geen pakket met een terugverdientijd binnen 10 jaar. ' +
