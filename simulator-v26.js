...
(function() {
    ...
    function generateReport() {
        ...
        var html = buildReportHTML(d, reportDate, recommendation, plusCum, proCum, summerDay, winterDay, springDay, autumnDay, currentResult, currentDisplayName, currentROI, recommendedPakket);
    ...
    function buildReportHTML(d, reportDate, recommendation, plusCum, proCum, summerDay, winterDay, springDay, autumnDay, currentResult, currentDisplayName, currentROI, recommendedPakket) {
        var plusPrice = PAKKETTEN[1].price;
        var proPrice = PAKKETTEN[2].price;
